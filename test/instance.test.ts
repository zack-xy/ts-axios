...
describe('instance', () => {
    ...
    test('should make a http request without verb help', () => {
    ...
    test('should make a option request', () => {
      const instance = axios.create()
    ...
    test('should get the computed uri', () => {
      ...
      expect(axios.getUri(fakeConfig)).toBe('https://www.baidu.com/user/12345?name=zack&age=18')
    })
})
